...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
        <a class="navbar-brand" href="#">Movie Delete</a>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="movieCrud.jsp">Back</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/movieServlet?id=<%=movie.getId()%>">Delete❌</a></td>
            </tr>
            <% } %>
            </tbody>
        </table>
