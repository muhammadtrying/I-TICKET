...
<%
    ...
    for (int i = 0; i < 8; i++) { // Adjust the loop as per your requirement
...
<div class="container">
    <div class="form-container">
        ...
        <form action="${pageContext.request.contextPath}/session-servlet" method="post">
            ...
            <div class="form-group">
                <input type="submit" value="Create Session" class="btn btn-primary btn-block">
            </div>
        </form>
    </div>
</div>
